...
export default function PartnerManagement() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Partners Cards Grid */}
      {loading ? (
        <div className="bg-white border-slate-200 shadow-sm border rounded-2xl p-12 flex flex-col items-center justify-center min-h-[300px]">
          <Loader2 className="w-8 h-8 text-red-500 animate-spin mb-4" />
          <p className="text-slate-500 text-sm font-medium">Loading partners data...</p>
        </div>
      ) : partners.length === 0 ? (
        <div className="bg-white border-slate-200 shadow-sm border rounded-2xl p-12 text-center max-w-xl mx-auto space-y-4">
          ...
          {partners.map((partner) => {
            ...
            return (
              <motion.div
                key={partner._id}
                layout
                className="bg-white border-slate-200 shadow-sm border rounded-2xl p-5 flex flex-col items-center text-center relative overflow-hidden transition-all group hover:"
              >
                {/* Logo wrapper */}
        ...
        {showModal && (
          <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 overflow-y-auto">
            <motion.div
              ...
              className="bg-white border-slate-200 shadow-sm border rounded-2xl w-full max-w-md shadow-2xl overflow-hidden my-8"
            >
              {/* Modal Head Banner */}
        ...
        {confirmDeleteId && (
          <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 overflow-y-auto">
            <motion.div
              ...
              animate={{ scale: 1, opacity: 1 }}
              exit={{ scale: 0.95, opacity: 0 }}
              className="bg-white border-slate-200 shadow-sm border rounded-2xl w-full max-w-sm shadow-2xl overflow-hidden my-8 p-6 text-center relative"
            >
