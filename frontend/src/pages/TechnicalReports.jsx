    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 p-4 md:p-8 pb-16">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="bg-white border-slate-200 shadow-sm border rounded-2xl p-4 text-center shadow-xs">
          ...
          <div className="bg-white border-slate-200 shadow-sm border border-amber-100 rounded-2xl p-4 text-center shadow-xs bg-amber-50/30">
          ...
          <div className="bg-white border-slate-200 shadow-sm border border-emerald-100 rounded-2xl p-4 text-center shadow-xs bg-emerald-50/30">
        ...
        {!isTechAdmin && (
          <>
            {/* Issue Type Selector */}
            <div className="bg-white border-slate-200 shadow-sm border rounded-2xl p-2 shadow-xs flex gap-2">
              <button
                type="button"
            ...
            {/* Submit Form */}
            <form onSubmit={handleSubmit} className="bg-white border-slate-200 shadow-sm border rounded-2xl p-6 space-y-4">
        ...
        <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <div className="relative">
                <input
                  ...
                  className="pl-3 pr-3 py-1.5 bg-white border-slate-200 shadow-sm border rounded-xl text-xs text-slate-900 focus:outline-none focus:border-red-500"
                />
              </div>
              ...
              <select
                ...
                className="bg-white border-slate-200 shadow-sm border rounded-xl px-3 py-1.5 text-xs text-slate-700 font-semibold cursor-pointer"
              >
              ...
              <button
                ...
                className="p-1.5 bg-white border-slate-200 shadow-sm border rounded-xl text-slate-600 hover:text-slate-900 transition cursor-pointer"
          ...
          {loading ? (
            ...
            <div className="bg-white border-slate-200 shadow-sm border rounded-2xl p-8 text-center text-slate-500 text-sm shadow-xs">
              {isTechAdmin ? 'No matching technical reports found in system queue.' : 'You have not submitted any technical reports yet.'}
            </div>
          ) : (
            <div className="space-y-3">
              {filteredReports.map((rep) => (
                <div key={rep.id} className="bg-white border-slate-200 shadow-sm border rounded-2xl p-5 shadow-xs space-y-3 hover: transition">
                      ...
                      {replyingId === rep.id ? (
                        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 space-y-3">
                          ...
                          <textarea
                            ...
                            className="w-full bg-white border-slate-200 shadow-sm border rounded-xl p-3 text-xs text-slate-900 focus:outline-none focus:border-red-500 resize-none"
                          />
                          ...
                          <div className="flex items-center justify-between flex-wrap gap-2">
                            <div className="flex items-center gap-2 text-xs">
                              ...
                              <select
                                ...
                                className="bg-white border-slate-200 shadow-sm border rounded-xl px-2.5 py-1 font-bold text-slate-800 focus:outline-none"
                              >
                                <option value="Resolved">Resolved</option>
                                <option value="In Progress">In Progress</option>
