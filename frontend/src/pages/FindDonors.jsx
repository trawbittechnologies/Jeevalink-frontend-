  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950 px-6 pt-6 pb-24 select-none">
      <div className="max-w-7xl mx-auto">
        {/* Top Filter Block */}
      <div className="bg-white border-slate-200 shadow-sm dark:bg-zinc-900 border dark:border-zinc-800 rounded-3xl p-5 mb-5">
      ...
      <div className="hidden md:grid md:grid-cols-12 md:gap-6 md:items-start animate-fade-in">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              {donors.map((donor) => {
                return (
                  <div
                    key={donor._id}
                    className="p-4 bg-white border-slate-200 shadow-sm dark:bg-zinc-900 border dark:border-zinc-800 rounded-2xl hover:border-slate-300 dark:hover:border-zinc-700 transition-all flex flex-col justify-between gap-3"
                  >
                    <div>
        ...
        <div className="md:col-span-5 sticky top-24 space-y-4">
          <MapContainer 
            donors={donors} 
            requests={requests.filter(r => (r.verified === true || r.verified === 1) && !r.pending_approval && ['Pending', 'Waiting', 'Accepted'].includes(r.status))}
          ...
          />
          <div className="bg-white border-slate-200 shadow-sm dark:bg-zinc-900 border /50 dark:border-zinc-800/60 rounded-2xl p-3 text-[10px] text-slate-400 font-medium">
              ...
              <div className="space-y-3">
                {donors.map((donor) => {
                  return (
                    <div
                      key={donor._id}
                      className="p-4 bg-white border-slate-200 shadow-sm dark:bg-zinc-900 border dark:border-zinc-800 rounded-2xl hover:border-slate-300 dark:hover:border-zinc-700 transition-colors flex items-start justify-between gap-3"
                    >
