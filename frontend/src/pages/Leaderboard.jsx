      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-200 pb-6">
          ...
          <button 
            ...
            className="px-4 py-2 bg-white border-slate-200 shadow-sm border hover:bg-slate-50 text-slate-700 rounded-xl text-xs font-semibold transition flex items-center gap-2 self-start md:self-auto cursor-pointer"
          >
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            ...
            {activeTab === 'donors' && (
              <div className="bg-white border-slate-200 shadow-sm border rounded-2xl p-5 md:p-6 space-y-3">
              ...
              <div className="bg-white border-slate-200 shadow-sm border rounded-2xl p-5 md:p-6 space-y-3">
                ...
                {(data.highest_block_committee || []).length === 0 ? (
                  ...
                  (data.highest_block_committee || []).map((b, idx) => (
                    <div 
                      key={idx}
                      className="flex items-center justify-between p-4 rounded-xl bg-white border-slate-200 shadow-sm border hover:"
                    >
                      <div className="flex items-center gap-3">
                        {getRankBadge(idx)}
                        <div>
            ...
            {activeTab === 'badges' && (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {[
                  ...
                  return (
                    <div key={i} className="p-6 rounded-2xl bg-white border-slate-200 shadow-sm border hover: transition space-y-3 relative overflow-hidden">
