...
const POSTER_CONFIG = {
  ...
  bloodGroup: { top: '46.5%', left: '76%', fontSize: '7cqi', color: '#dc2626', fontWeight: 'black', width: '15%', transform: 'translate(-50%, -50%)', textAlign: 'center' },
  units: { top: '61%', left: '76%', fontSize: '3.2cqi', color: '#ffffff', fontWeight: 'bold', width: '25%', transform: 'translate(-50%, -50%)', textAlign: 'center', textShadow: '0px 1px 3px rgba(0,0,0,0.6)' },
