...
const POSTER_CONFIG = {
  ...
  bloodGroup: { top: '55mm', left: '68.5mm', fontSize: '6.3mm', color: '#dc2626', fontWeight: 'black', width: '18mm', transform: 'translate(-50%, -50%)', textAlign: 'center' },
  units: { top: '65mm', left: '68.5mm', fontSize: '2.88mm', color: '#ffffff', fontWeight: 'bold', width: '22.5mm', transform: 'translate(-50%, -50%)', textAlign: 'center', textShadow: '0px 1px 3px rgba(0,0,0,0.6)' },
