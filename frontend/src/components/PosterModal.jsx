...
const POSTER_CONFIG = {
  ...
  units: { top: '115mm', left: '69mm', fontSize: '2.88mm', color: '#ffffff', fontWeight: 'bold', width: '22.5mm', transform: 'translate(-50%, -50%)', textAlign: 'center', textShadow: '0px 1px 3px rgba(0,0,0,0.6)' },
