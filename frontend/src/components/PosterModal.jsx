...
const POSTER_CONFIG = {
  ...
  bloodGroup: { top: '53mm', left: '68mm', fontSize: '6.5mm', color: '#dc2626', fontWeight: '400', fontFamily: "'Righteous', display", letterSpacing: '0.02em', width: '18mm', transform: 'translate(-50%, -50%)', textAlign: 'center', textShadow: '1px 1px 0px rgba(220,38,38,0.2)' },
  units: { top: '58mm', left: '68.5mm', fontSize: '2.6mm', color: '#ffffff', fontWeight: '700', fontFamily: "'Space Grotesk', sans-serif", letterSpacing: '0.05em', width: '22.5mm', transform: 'translate(-50%, -50%)', textAlign: 'center', textShadow: '0px 1px 4px rgba(0,0,0,0.8)' },
